...
describe("BatteryScreen", () => {
  ...
  test("pressing the primary action fires the battery settings intent and advances to the provider picker", () => {
    render(<BatteryScreen brand={null} />);
  ...
  test("skipping advances to the provider picker without opening the intent", () => {
    render(<BatteryScreen brand={null} />);
