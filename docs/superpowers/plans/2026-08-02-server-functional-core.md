...
- Create: `server/prisma/migrations/<timestamp>_init/migration.sql` (generated by `prisma migrate dev`)
- Test: `server/test/prisma_schema.test.ts`
...
`server/test/prisma_schema.test.ts`:
...
Append to `server/prisma/schema.prisma` (below the datasource block):
...
- Create: `server/src/routes/health_routes.ts`
- Create: `server/src/app.ts`
- Create: `server/src/server.ts`
- Test: `server/test/routes/health_routes.test.ts`
- Test: `server/test/lib/errors.test.ts`
...
`server/test/routes/health_routes.test.ts`:
...
`server/test/lib/errors.test.ts`:
...
**Files:**
- Create: `server/src/plugins/prisma_plugin.ts`
- Modify: `server/src/app.ts` (register the plugin)
- Test: `server/test/plugins/prisma_plugin.test.ts`
...
`server/test/plugins/prisma_plugin.test.ts`:
...
Add to the imports in `server/src/app.ts`:
...
**Files:**
- Create: `server/src/lib/hashing.ts`
- Create: `server/src/lib/otp.ts`
- Test: `server/test/lib/otp.test.ts`
...
**Files:**
- Create: `server/src/services/auth_service.ts`
- Create: `server/src/routes/auth_routes.ts`
- Create: `server/test/helpers/db.ts`
- Modify: `server/src/app.ts` (register `authRoutes` under `/v1`)
- Test: `server/test/routes/auth_otp_routes.test.ts`
...
`server/test/routes/auth_otp_routes.test.ts`:
...
**Files:**
- Modify: `server/src/services/auth_service.ts` (add `verifyOtp`, `issueRefreshToken`)
- Modify: `server/src/routes/auth_routes.ts` (add `POST /auth/otp/verify`)
- Test: `server/test/routes/auth_otp_routes.test.ts` (append a describe block)
...
Append to `server/test/routes/auth_otp_routes.test.ts`. Add these imports at the top of the file:
...
**Files:**
- Modify: `server/src/services/auth_service.ts` (add `classifyRefreshToken`, `rotateRefreshToken`)
- Modify: `server/src/routes/auth_routes.ts` (add `POST /auth/token/refresh`)
- Test: `server/test/services/auth_service.test.ts`
- Test: `server/test/routes/auth_refresh_routes.test.ts`
...
`server/test/services/auth_service.test.ts`:
...
`server/test/routes/auth_refresh_routes.test.ts`:
...
**Files:**
- Create: `server/src/plugins/auth_plugin.ts`
- Modify: `server/src/app.ts` (register the plugin)
- Test: `server/test/plugins/auth_plugin.test.ts`
...
`server/test/plugins/auth_plugin.test.ts`:
...
**Files:**
- Create: `server/prisma/seed_data.ts`
- Create: `server/prisma/seed.ts`
- Create: `server/src/routes/parser_rules_routes.ts`
- Modify: `server/src/app.ts` (register the route)
- Test: `server/test/seed_data.test.ts`
- Test: `server/test/routes/parser_rules_routes.test.ts`
...
`server/test/routes/parser_rules_routes.test.ts`:
...
**Files:**
- Create: `server/src/routes/telemetry_routes.ts`
- Modify: `server/src/app.ts` (register `@fastify/rate-limit` with `global: false`, register the route)
- Test: `server/test/routes/telemetry_routes.test.ts`
...
`server/test/routes/telemetry_routes.test.ts`:
...
**Files:**
- Create: `server/src/routes/backup_routes.ts`
- Create: `server/test/helpers/auth.ts`
- Modify: `server/src/app.ts` (register the route)
- Test: `server/test/routes/backup_routes.test.ts`
...
`server/test/routes/backup_routes.test.ts`:
...
**Files:**
- Create: `server/src/routes/entitlements_routes.ts`
- Modify: `server/src/app.ts` (register the route)
- Test: `server/test/routes/entitlements_routes.test.ts`
...
`server/test/routes/entitlements_routes.test.ts`:
